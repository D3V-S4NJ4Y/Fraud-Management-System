...
('CF2024001', (SELECT id FROM "User" WHERE email = 'victim@example.com'), 'Rajesh Kumar', 'victim@example.com', '+91 9876543212', 'PHISHING', 50000, '2024-01-15', 'Received phishing email claiming to be from bank asking for OTP', 'State Bank of India', '****1234', 'TXN123456789', 'FUNDS_FROZEN', 'HIGH', 'Cyber Crime Police Station', 'Mumbai', 'Inspector R. Kumar'),
('CF2024002', (SELECT id FROM "User" WHERE email = 'victim@example.com'), 'Priya Sharma', 'priya@example.com', '+91 9123456789', 'ONLINE_SHOPPING', 25000, '2024-01-18', 'Fake online shopping website, paid but never received product', 'HDFC Bank', '****5678', 'TXN987654321', 'REFUND_PROCESSING', 'MEDIUM', 'Cyber Crime Police Station', 'Delhi', null)
